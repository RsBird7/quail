...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Mindmap_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Mindmap_t qt_meta_stringdata_Mindmap = {
    {
QT_MOC_LITERAL(0, 0, 7) // "Mindmap"
...
QT_INIT_METAOBJECT const QMetaObject Mindmap::staticMetaObject = { {
    QMetaObject::SuperData::link<QMainWindow::staticMetaObject>(),
    qt_meta_stringdata_Mindmap.data,
    qt_meta_data_Mindmap,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *Mindmap::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Mindmap.stringdata0))
